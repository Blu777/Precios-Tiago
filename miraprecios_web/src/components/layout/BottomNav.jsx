...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-white/50 shadow-[0_-8px_20px_-1px_rgba(0,0,0,0.05)] z-50 pb-safe transition-all duration-300">
